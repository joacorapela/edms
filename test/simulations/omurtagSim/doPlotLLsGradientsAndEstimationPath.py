...
def main(argv):
    ...
    llsAndGradientsFigFilename = llsAndGradientsFilenamePattern % ("figures", t0, tf, dt, trueWEI, trueWIE, wEIsStart, wEIsStop, wEIsStep, wIEsStart, wIEsStop, wIEsStep, ysSigma, "estimationPath.eps")
    ...
    plt.plot(ws[:, 1], ws[:, 0], color=estimationPathColor,
                       linestyle=estimationPathLS, linewidth=estimationPathLW,
                       marker=estimationPathMarker)
