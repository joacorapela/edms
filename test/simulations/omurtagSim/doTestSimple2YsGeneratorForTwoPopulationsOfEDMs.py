...
#     tf = 1.0
    ...
    sigma = 2.0
    xticksSep = 0.1
    resultsFilenamePattern = "%s/simple2YsForTwoPopulationsT0%.02fTf%.02fDt%fWEI%.02fWIE%.02fSigma%.02f.%s"
    ...
    integrator = TwoPopulationsIFEnsembleDensitySimple2Integrator(\
