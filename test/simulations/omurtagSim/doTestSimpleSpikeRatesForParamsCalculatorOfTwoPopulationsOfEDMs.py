...
#     tf = 1.0
    ...
    resultsFilename = "results/spikeRatesForParamsOfTwoPopulationsT0%.02fTf%.02fDt%fWEIs%d-%d-%dWIEs%d-%d-%d.npz" % (t0, tf, dt, wEIsStart, wEIsStop, wEIsStep, wIEsStart, wIEsStop, wIEsStep)
    ...
    twoPIFEDIntegrator = TwoPopulationsIFEnsembleDensitySimpleIntegrator()
    spikeRatesForParamsCalculator = \
     SimpleSpikeRatesForParamsCalculatorOfTwoPopulationsOfEDMs(\
      eInputs=eInputs, dt=dt, dv=dv, eRho0=eRho0, iRho0=iRho0, 
      a0=a0, a1=a1, a2=a2, reversedQs=reversedQs,
